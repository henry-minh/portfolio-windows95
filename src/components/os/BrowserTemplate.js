...
import "../../styles/browserTemplate.css";
import Draggable from "react-draggable";

function BrowserTemplate({ item, xValue, yValue, zValue, icon, browserContent, isRunning, hidden, maximized, maximizeBrowser, closeBrowser, minmizeBrowser, changeBrowserFocus }) {
